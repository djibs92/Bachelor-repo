...
class ConnectionFactory:
    ...
    def _create_aws_connection(auth_mode: Dict[str, Any]):
        ...
        if auth_mode["type"] == "sts":
            from api.services.provider.aws.connexion_aws.sts_connector import get_assumed_session
        ...
        raise ValueError(f"Mode d'authentification AWS non supporté: {auth_mode['type']}")